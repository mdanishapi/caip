...
# **IMPORTANT: These values are placeholders based on previous calculations.**
# **You must run the main modeling script to confirm the exact final coefficients.**
SHOCK_COEFFICIENT = -8.70 # Placeholder: Change in Kcal/capita/day per 1% shock
RMSE_VALUE = 65.03      # Placeholder: RMSE of the Linear Regression Model
...
try:
    ...
    st.error(f"Error: The processed data file ('{output_file_name}') was not found. Please run the main modeling script first.")
    st.stop()
...
with tab2:
    ...
    with col_input:
        ...
        # Note the updated description to reflect the full Total Supply calculation
