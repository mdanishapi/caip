...
with tab2:
    ...
    with col_output:
        ...
        # This is where the predicted_deviation is defined, inside the Streamlit context
...
[Image of Linear Regression Model Parameters]
    ...
    col_b.metric("Shock Coefficient (B)", f"-0.0987 kcal per 1% shock")
    col_b.metric("Model RMSE (Deviation)", f"0.69 kcal/cap/day")
    col_b.caption(f"**Interpretation**: A +1% increase in the lagged Systemic Supply Shock index is quantified as a -0.0987 kcal/capita/day change in utilization.")
